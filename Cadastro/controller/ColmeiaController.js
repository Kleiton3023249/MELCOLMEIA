...
const cadastraColmeia = async (req, res) => {
    ...
    const {nome, saude, especie, qtdAbelha, tipoColmeia, tempMedia} = req.body
    
    const response = await Colmeia.cadastraColmeia({nome, saude, especie, qtdAbelha, tipoColmeia, tempMedia})
